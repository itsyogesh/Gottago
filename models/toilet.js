...
var ToiletSchema = new mongoose.Schema({
	...
	'is_handicapped': {type: Boolean, default: false},
	'shower_facility': {type: Boolean, default: false},
	'charges': {type: Number, default: 0},
	'hours': {type:[Hours], default: [{open_time: 0000, close_time: 2400}]},
	'style': {type: String, enum: ['indian', 'western', 'both', 'toilet'], default: 'toilet'},
